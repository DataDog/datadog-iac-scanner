	...
	tests := []struct {
		...
		},
		{
			...
			expectedOutput: scan.ScanStats{
				...
				ViolationBreakdowns: map[string]map[string]int{
					"LOW": {
						"cicd-common-anonymous-definition":                    1,
						"cicd-common-concurrency-limits":                      1,
						"cicd-common-unpinned-actions-full-length-commit-sha": 1,
					},
					"MEDIUM": {
						"cicd-common-unspecified-workflows-permissions": 1,
					},
				},
			},
		},
