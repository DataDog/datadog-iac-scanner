...
meta:
  name: "kubernetes/security_context_deny_admission_control_plugin_not_set"
...
**Id:** {{< copyable-code >}}kubernetes-security-context-deny-admission-control-plugin-not-set{{< /copyable-code >}}
