...
meta:
  ...
  id: "cloudformation-aws-elb-with-security-group-without-outbound-rules"
...
**Id:** {{< copyable-code >}}cloudformation-aws-elb-with-security-group-without-outbound-rules{{< /copyable-code >}}
