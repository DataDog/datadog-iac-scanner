...
meta:
  name: "kubernetes/audit_log_maxsize_not_properly_set"
  id: "kubernetes-audit-log-maxsize-not-properly-set"
...
**Id:** {{< copyable-code >}}kubernetes-audit-log-maxsize-not-properly-set{{< /copyable-code >}}
