...
meta:
  ...
  id: "terraform-azure-postgresql-server-threat-detection-policy-disabled"
...
**Id:** {{< copyable-code >}}terraform-azure-postgresql-server-threat-detection-policy-disabled{{< /copyable-code >}}
