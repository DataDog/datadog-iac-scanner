...
meta:
  ...
  id: "terraform-aws-codebuild-project-encrypted-with-aws-managed-key"
...
**Id:** {{< copyable-code >}}terraform-aws-codebuild-project-encrypted-with-aws-managed-key{{< /copyable-code >}}
