...
meta:
  ...
  id: "terraform-aws-docdb-cluster-encrypted-with-aws-managed-key"
...
**Id:** {{< copyable-code >}}terraform-aws-docdb-cluster-encrypted-with-aws-managed-key{{< /copyable-code >}}
