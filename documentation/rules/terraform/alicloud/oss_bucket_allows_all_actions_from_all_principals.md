...
meta:
  ...
  id: "terraform-alicloud-oss-bucket-allows-all-actions-from-all-principals"
...
**Id:** {{< copyable-code >}}terraform-alicloud-oss-bucket-allows-all-actions-from-all-principals{{< /copyable-code >}}
