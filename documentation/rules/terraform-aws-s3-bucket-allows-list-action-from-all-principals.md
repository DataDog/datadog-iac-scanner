...
meta:
  ...
  id: "terraform-aws-s3-bucket-allows-list-action-from-all-principals"
...
**Id:** {{< copyable-code >}}terraform-aws-s3-bucket-allows-list-action-from-all-principals{{< /copyable-code >}}
