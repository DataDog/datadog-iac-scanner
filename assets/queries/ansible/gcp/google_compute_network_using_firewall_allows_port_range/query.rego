...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": sprintf("'%s' should not be using a firewall rule that allows access to port range", [canonical_network]),
		"keyActualValue": sprintf("'%s' is using a firewall rule that allows access to port range", [canonical_network]),
