...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": sprintf("'%s' should not be using a default firewall rule", [canonical_network]),
		"keyActualValue": sprintf("'%s' is using a default firewall rule", [canonical_network]),
