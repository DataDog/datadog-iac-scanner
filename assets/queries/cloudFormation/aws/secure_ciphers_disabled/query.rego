...
CxPolicy[result] {
	...
	cf_lib.normalize_cloudFormation_boolean(resource.Properties.ViewerCertificate.CloudFrontDefaultCertificate) == "false"
	not common_lib.inArray({"TLSv1.1", "TLSv1.2"}, resource.Properties.ViewerCertificate.MinimumProtocolVersion)
