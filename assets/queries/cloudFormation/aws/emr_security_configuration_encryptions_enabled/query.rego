...
CxPolicy[result] {
	...
	cf_lib.normalize_cloudFormation_boolean(properties.SecurityConfiguration.EncryptionConfiguration.AtRestEncryptionConfiguration.LocalDiskEncryptionConfiguration.EnableEbsEncryption) == "false"
...
CxPolicy[result] {
	...
	properties := resource.Properties
	cf_lib.normalize_cloudFormation_boolean(properties.SecurityConfiguration.EncryptionConfiguration.EnableInTransitEncryption) == "false"
...
CxPolicy[result] {
	...
	properties := resource.Properties
	cf_lib.normalize_cloudFormation_boolean(properties.SecurityConfiguration.EncryptionConfiguration.EnableAtRestEncryption) == "false"
