...
CxPolicy[result] {
	...
	cf_lib.normalize_cloudFormation_boolean(stageDescription.CachingEnabled) == "true"
...
CxPolicy[result] {
	...
	cf_lib.normalize_cloudFormation_boolean(stageDescription.CacheDataEncrypted) == "false"
