...
CxPolicy[result] {
	...
	cf_lib.normalize_cloudFormation_boolean(resource.Properties.Enabled) == "true"
...
CxPolicy[result] {
	...
	cf_lib.normalize_cloudFormation_boolean(resource.Properties.Enabled) == "true"
	not common_lib.valid_key(resource.Properties, "PendingWindowInDays")
	cf_lib.normalize_cloudFormation_boolean(resource.Properties.EnableKeyRotation) == "false"
