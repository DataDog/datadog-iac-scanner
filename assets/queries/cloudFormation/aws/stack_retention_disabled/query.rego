...
CxPolicy[result] {
    ...
    cf_lib.normalize_cloudFormation_boolean(autoDeployment.Enabled) == "false"
...
CxPolicy[result] {
    ...
    cf_lib.normalize_cloudFormation_boolean(autoDeployment.RetainStacksOnAccountRemoval) == "false"
