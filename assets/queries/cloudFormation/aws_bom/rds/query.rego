...
get_resource_accessibility(resource) = accessibility{
    ...
    cf_lib.normalize_cloudFormation_boolean(resource.Properties.PubliclyAccessible) == "false"
...
get_enc_for_not_aurora(resource) = encryption{
	...
	cf_lib.normalize_cloudFormation_boolean(resource.Properties.StorageEncrypted) == "false"
