...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": "tencentcloud_kubernetes_cluster",
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("tencentcloud_kubernetes_cluster[%s].master_config[%d].public_ip_assigned", [name, index]),
...
CxPolicy[result] {
	...
	result := {
        ...
        "resourceType": "tencentcloud_kubernetes_cluster",
        "resourceName": tf_lib.get_resource_name(resource, name),
        "searchKey": sprintf("tencentcloud_kubernetes_cluster[%s].master_config[%d].internet_max_bandwidth_out", [name, index]),
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": "tencentcloud_kubernetes_cluster",
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("tencentcloud_kubernetes_cluster[%s].worker_config[%d].public_ip_assigned", [name, index]),
...
CxPolicy[result] {
	...
	result := {
        ...
        "resourceType": "tencentcloud_kubernetes_cluster",
        "resourceName": tf_lib.get_resource_name(resource, name),
        "searchKey": sprintf("tencentcloud_kubernetes_cluster[%s].worker_config[%d].internet_max_bandwidth_out", [name, index]),
