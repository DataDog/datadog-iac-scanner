...
CxPolicy[result] {
	...
	result := {
		...
		"searchKey": sprintf("aws_elasticsearch_domain_policy[%s].access_policies.Statement[%d].Action", [name, idx]),
		...
		"searchLine": common_lib.build_search_line(["resource", "aws_elasticsearch_domain_policy", name, "access_policies", "Statement", idx, "Action"], []),
	}
}
