...
// minimalCfgFile is used by hasIacSectionForSupportedVersion to detect whether the config
// file has an iac: section. All root-level product keys are listed so that KnownFields
// rejects unrecognized root properties per the RFC requirement.
