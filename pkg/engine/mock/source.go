...
import (
	...
	source "github.com/DataDog/datadog-iac-scanner/pkg/engine/source"
	model "github.com/DataDog/datadog-iac-scanner/pkg/model"
...
func (m *MockQueriesSource) GetQueries(ctx context.Context, querySelection *source.QueryInspectorParameters) ([]model.QueryMetadata, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetQueries", ctx, querySelection)
...
func (mr *MockQueriesSourceMockRecorder) GetQueries(ctx, querySelection interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetQueries", reflect.TypeOf((*MockQueriesSource)(nil).GetQueries), ctx, querySelection)
}
...
func (m *MockQueriesSource) GetQueryLibrary(ctx context.Context, platform string) (source.RegoLibraries, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetQueryLibrary", ctx, platform)
...
func (mr *MockQueriesSourceMockRecorder) GetQueryLibrary(ctx, platform interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetQueryLibrary", reflect.TypeOf((*MockQueriesSource)(nil).GetQueryLibrary), ctx, platform)
}
