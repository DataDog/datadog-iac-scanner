...
- Use `contains()` for list fields (e.g., `cidr_blocks`) vs `==` for scalar fields (e.g., `cidr`)
- Handle both single-block and array-block ingress patterns in Terraform security group rules
