...
LIB = $(shell pwd)/lib
IMAGE_TAG := dev
TARGET_BIN ?= bin/datadog-iac-scanner
CONSTANTS_PATH = github.com/DataDog/datadog-iac-scanner/internal/constants
...
test-e2e: build
	$(call print-target)
	go test "github.com/DataDog/datadog-iac-scanner/e2e" -v -timeout 1500s
